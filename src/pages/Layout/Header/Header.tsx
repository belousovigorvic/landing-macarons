            ...
            <nav className={classes.header__top_nav}>
              <ul className={classes.header__top_ul}>
                <li className={classes.header__top_li}>
                  ...
                  <span className={classes.header__top_city}>Санкт-Петербург</span>
                ...
                <li className={classes.header__top_li}>
                  <img className={classes.header__top_bag} src={bagIcon} alt="bagIcon" />
                  <span>В корзине (4 товара)</span>
                </li>
                <li className={`${classes.header__top_li} ${classes.header__top_social}`}>
